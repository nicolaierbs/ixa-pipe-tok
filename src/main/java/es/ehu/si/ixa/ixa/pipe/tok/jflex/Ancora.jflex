...
ABBREV_MONTH_ES = Ene|Febr|Mar|Abr|May|Jun|Ag|Sep|Sept|Oct|Nov|Dec
...
ABBREV_COMP = Inc|Cos?|Pp?t[ye]s?|Ltd|Plc|Rt|Bancorp|Bhd|S\.A\.|S\.L\.
...
ABBREV_PREFIX = {ABBREV_PREFIX_EN}|{ABBREV_PREFIX_ES}
