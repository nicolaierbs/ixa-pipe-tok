...
%{
  ...
  private static final Logger LOGGER = Logger.getLogger(Ctag.class.getName());
  ...
  public Ctag(Reader breader, TokenFactory tokenFactory, Properties
  properties) {
    this(breader);
    ...
    else if (normalize.equalsIgnoreCase("ctag")) {
        escapeForwardSlash = false;
        normalizeBrackets = false;
        normalizeOtherBrackets = false;
        latexQuotes = false;
...
ABBREV_MONTH = {ABBREV_MONTH_EN}|{ABBREV_MONTH_ES}|{ABBREV_MONTH_GL}
...
ABBREV_DAYS = {ABBREV_DAYS_EN}|{ABBREV_DAYS_ES}|{ABBREV_DAYS_GL}
...
ABBREV_PREFIX = {ABBREV_PREFIX_EN}|{ABBREV_PREFIX_GL}|{ABBREV_PREFIX_ES}
