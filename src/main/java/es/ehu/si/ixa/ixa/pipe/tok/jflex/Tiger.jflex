...
ABBREV_MONTH = {ABBREV_MONTH_DE}|{ABBREV_MONTH_EN}


ABBREV_DAYS_DE = So|Mo|Di|Mi|Do|Fr|Sa
ABBREV_DAYS_EN = Mon|Tue|Tues|Wed|Thu|Thurs|Fri|Sat

ABBREV_DAYS = {ABBREV_DAYS_DE}|{ABBREV_DAYS_EN}
...
ABBREV_PREFIX_DE=Dkr|Betr|Empf|Hrn|abds|abgedr|abgeschl|abs|abzgl|akt|allg|allgem|allj|alph|amtl|and|anerk|ang|anschl|ausgest|ausgez|ausl|ausschl|aut|auth|bef|befr|beil|ber|bes|best|betr|bev|bew|bez|br|bsd|bspw|bwgl|bzgl|bzw|ca|chem|demn|dergl|desgl|dgl|div|do|dstl|dt|dto|dtsch|eh|ea|ebd|ed|ehel|ehem|ehm|eig|eigtl|eingetr|eingez|einh|einschl|einst|einz|em|engl|enth|entspr|entw|erb|erf|erg|erh|erl|erm|erstkl|erw|etc|etw|ev|ev-luth|evt|evtl|ew|exkl|ff|fl|folg|fortl|fr|frz|gb|geb|gebr|geg|gegr|geh|gek|gel|gem|gen|gepl|gepr|ger|ges|gesch|geschl|gesp|gest|get|getr|gew|gez|gg|ggf|ggs|ggz|glt|gltg|gr|gt|gyn|habil|hdgm|hdschr|herg|hins|hist|hl|hpts|hrsg|hs|hum|hydr|hzb|ill|inbegr|inf|inkl|inoff|insb|insbes|int|inv|jew|jg|jhrl|jr|jun|jur|kath|kfm|kgl|kl|komm|kompl|kons|konz|kpl|kt|künstl|landw|lb|ld|led|leg|leit|lfd|lg|lgfr|lit|liz|lt|luth|magn|masch|max|mbl|mdls|mech|med|mehrf|met|min|mind|mm|mod|mst|mtl|möbl|mögl|nachm|nat|nb|ndl|neutr|neuw|nhd|no|not|od|off|op|opt|or|ord|org|orth|pat|perf|pers|pharm|phys|pol|pos|pp|ppa|priv|prot|prov|psych|päd|r-k|rd|ref|reg|rel|ren|res|resp|restl|rückw|schw|sek|selbstv|sen|sep|sof|sog|sogen|sonst|sow|soz|spez|st|staatl|stdl|stellv|stg|stud|stv|städt|sym|syst|system|teilw|tel|tgl|tlw|tägl|umf|unbed|unbek|ung|ungebr|ungek|unreg|unv|unverb|unw|urspr|usf|usw|ver|verf|verg|verh|verk|verl|verm|verp|vers|versch|verst|vertr|verw|verz|vgl|vollst|vorh|vorm|vorw|wbl|wd|wg|wiss|wö|zahlr|zeitw|zgl|ziv|zuf|zugl|zul|zus|zust|zw|zz|zzgl|zzt|öff|öfftl|ökon|üb|überh|übers

ABBREV_PREFIX = {ABBREV_PREFIX_DE}|{ABBREV_PREFIX_EN}
